...
<div class="container">
  <div class="content">
    ...
    <h3 style="color: white;">Autogarage</h2>
     <a href="dashboard?jenis=mobil"> <div class="icon icon-fill"><img src="./image/rnj_autogarage.jpg" height="120" width="120">
   
    </div></a>
    <h3 style="color: white;">Motosport</h2>
   
      <!-- <div class="icon icon-rotate"><i class="fa fa-whatsapp"></i></div> -->
      <a href="dashboard?jenis=motor"> <div class="icon icon-fill"><img src="./image/logo.png" height="120" width="120"></div></a>
    </div>
